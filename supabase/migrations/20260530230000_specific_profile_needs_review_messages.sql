...
begin
  ...
  v_risk_flags := coalesce(v_profile_readiness->'risk_flags', '[]'::jsonb);
  ...
  return jsonb_build_object(
    ...
    'message', case
      ...
      when v_codes[1] = 'profile_needs_review' and v_risk_flags ? 'vague_loan_purpose'
        then 'Add more detail to your loan purpose before applying.'
      when v_codes[1] = 'profile_needs_review' then 'Update your flagged profile details before applying.'
