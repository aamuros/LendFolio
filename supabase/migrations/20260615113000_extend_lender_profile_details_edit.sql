...
drop function if exists public.complete_lender_profile_details(text, text, text, numeric, numeric);
...
grant execute on function public.complete_lender_profile_details(text, text, text, text, text, text, numeric, numeric, text, text, text, text, text, text) to authenticated;
