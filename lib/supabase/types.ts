    ...
    Functions: {
      ...
      submit_borrower_verification_document: {
        Args: {
          ...
          p_ai_review_confidence?: number | null;
          p_ai_detected_document_type?: string | null;
          p_ai_review_reason?: string | null;
          p_ai_risk_flags?: string[];
          p_ai_model?: string | null;
          p_ai_reviewed_at?: string | null;
        };
        Returns: Json;
      };
