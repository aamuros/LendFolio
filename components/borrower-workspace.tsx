...
function ProfileStatusBanner({
  ...
  return (
    <section className="grid grid-cols-[2.25rem_1fr] gap-3 rounded-2xl border border-[var(--border)] bg-white px-4 py-3 shadow-sm sm:grid-cols-[2.25rem_1fr_auto] sm:items-center">
      <span
      ...
      <div className="grid min-w-0 items-start gap-0">
        ...
        {status.actionLabel ? (
          <button
            type="button"
            onClick={onAction}
            className="mt-2 inline-flex h-10 items-center justify-center justify-self-start rounded-full border border-[var(--border)] bg-white px-4 text-xs font-semibold text-[var(--foreground)] transition hover:border-[var(--primary)] hover:text-[var(--primary)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--primary)] sm:hidden"
          >
            {status.actionLabel}
          </button>
        ) : null}
      ...
      {status.actionLabel ? (
        <button
          type="button"
          onClick={onAction}
          className="hidden h-10 items-center justify-center rounded-full border border-[var(--border)] bg-white px-4 text-xs font-semibold text-[var(--foreground)] transition hover:border-[var(--primary)] hover:text-[var(--primary)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--primary)] sm:inline-flex"
        >
          {status.actionLabel}
        </button>
      ) : null}
